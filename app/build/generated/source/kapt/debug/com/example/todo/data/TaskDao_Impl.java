  ...
  public TaskDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfTask = new EntityInsertionAdapter<Task>(__db) {
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        final String _tmp_2 = __localDateTimeConverter.fromLocalDateTime(entity.getDueDate());
        if (_tmp_2 == null) {
          statement.bindNull(6);
        } else {
          statement.bindString(6, _tmp_2);
        }
        final String _tmp_3 = __localDateTimeConverter.fromLocalDateTime(entity.getCreatedAt());
        if (_tmp_3 == null) {
          statement.bindNull(7);
        } else {
          statement.bindString(7, _tmp_3);
        }
        final String _tmp_4 = __localDateTimeConverter.fromLocalDateTime(entity.getUpdatedAt());
        if (_tmp_4 == null) {
      ...
      public List<Task> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _tmpDueDate = __localDateTimeConverter.toLocalDateTime(_tmp_2);
            ...
            _tmpCreatedAt = __localDateTimeConverter.toLocalDateTime(_tmp_3);
            ...
            _tmpUpdatedAt = __localDateTimeConverter.toLocalDateTime(_tmp_4);
